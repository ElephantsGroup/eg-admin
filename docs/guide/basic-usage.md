...
'modules' => [
    ...
    'admin' => [
        ...
        'controllerMap' => [
            'assignment' => [
                'class' => 'elephantsGroup\admin\controllers\AssignmentController',
...
The code below shows how to use ACF which is implemented as `elephantsGroup\admin\components\AccessControl`:
