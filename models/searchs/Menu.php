...
namespace elephantsGroup\admin\models\searchs;

use Yii;
use yii\base\Model;
use yii\data\ActiveDataProvider;
use elephantsGroup\admin\models\Menu as MenuModel;

/**
 * Menu represents the model behind the search form about [[\elephantsGroup\admin\models\Menu]].
 * 
